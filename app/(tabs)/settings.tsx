  ...
  return (
    <Modal visible={visible} animationType="slide" transparent>
      <BlurView intensity={20} style={styles.modalOverlay}>
        <View style={[styles.apiKeyModal, { backgroundColor: theme.colors.surface }]}>
          ...
          <View style={styles.modalContent}>
            ...
            <View style={styles.modalButtons}>
              ...
              <TouchableOpacity
                style={[styles.modalButton, { opacity: isValidating ? 0.7 : 1 }]}
                onPress={handleSave}
        ...
        <View style={styles.section}>
          ...
          <View style={styles.sectionCard}>
            <SettingItem
              ...
              title="AI API Key"
              subtitle={hasApiKey ? "OpenAI key configured ✓" : "Configure OpenAI API key"}
              color="#8B5CF6"
